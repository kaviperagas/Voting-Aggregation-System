...
public class IrElection extends Election{
     ...
     *
     * @param file The election file inputted by the user to be parsed.
     */
    public IrElection(File file){ // constructor
        this.file = file;
     ...
     * 
     * @param round the number corresponding to the current round of the election
     */
