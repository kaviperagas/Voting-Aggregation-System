...
public class OplElection extends Election {
     ...
     *
     * @param file The file inputted by the user to be parsed.
     */
    public OplElection(File file) {
        this.file = file;
    ...
    protected void processFile() {
        try {
            ...
            while((line = br.readLine())!=null) {
                ...
                if (line_no == 5){
                    setNumBallots(Integer.parseInt(line));
                    AuditService.appendToAuditFile("Set number of ballots to " + getNumBallots());
                    calculateQuota();
                }
